...
public class DatabaseCRH extends AppCompatActivity implements DatabaseCRHAdapter.CRHAdapterListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<id.variable.dicicilaja.API.Item.DatabaseCRH.DatabaseCRH> call = apiService.getDatabaseCRH(apiKey);
        call.enqueue(new Callback<id.variable.dicicilaja.API.Item.DatabaseCRH.DatabaseCRH>() {
            @Override
            public void onResponse(Call<id.variable.dicicilaja.API.Item.DatabaseCRH.DatabaseCRH> call, retrofit2.Response<id.variable.dicicilaja.API.Item.DatabaseCRH.DatabaseCRH> response) {
            ...
            @Override
            public void onFailure(Call<id.variable.dicicilaja.API.Item.DatabaseCRH.DatabaseCRH> call, Throwable t) {
