...
public class PengajuanMaxiAllAdapter extends RecyclerView.Adapter<PengajuanMaxiAllAdapter.RequestViewHolder>  {
    private List<id.variable.dicicilaja.API.Item.PengajuanMaxi.Datum> pengajuan;
    ...
    public PengajuanMaxiAllAdapter(List<id.variable.dicicilaja.API.Item.PengajuanMaxi.Datum> requests, int rowLayout, Context context) {
