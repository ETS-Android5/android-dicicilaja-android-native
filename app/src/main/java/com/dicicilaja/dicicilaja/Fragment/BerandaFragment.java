...
import com.dicicilaja.dicicilaja.Activity.AllPartnerActivity;
import com.dicicilaja.dicicilaja.Activity.AllPromoActivity;
import com.dicicilaja.dicicilaja.Activity.ProductCategoryActivity;
import com.dicicilaja.dicicilaja.Activity.PromoActivity;
...
import com.dicicilaja.dicicilaja.Activity.RemoteMarketplace.InterfaceAxi.InterfacePartner;
...
import com.dicicilaja.dicicilaja.Activity.SimulasiActivity;
import com.dicicilaja.dicicilaja.Adapter.ListPartnerAdapter;
import com.dicicilaja.dicicilaja.Adapter.ListPromoAdapter;
import com.dicicilaja.dicicilaja.Adapter.ListRekomendasiAdapter;
import com.dicicilaja.dicicilaja.Content.PartnerModel;
import com.dicicilaja.dicicilaja.Content.PromoModel;
import com.dicicilaja.dicicilaja.Content.RekomendasiModel;
...
//                NewRetrofitClient.getClient().create(InterfaceSimulation.class);
        ...
        call2.enqueue(new Callback<Recommendation>() {
            ...
            public void onResponse(Call<Recommendation> call, Response<Recommendation> response) {
                final List<com.dicicilaja.dicicilaja.Activity.RemoteMarketplace.Item.ItemRecommendation.Datum> recommends = response.body().getData();
        ...
        call3.enqueue(new Callback<Partner>() {
            ...
            public void onResponse(Call<Partner> call, Response<Partner> response) {
                final List<com.dicicilaja.dicicilaja.Activity.RemoteMarketplace.Item.ItemPartner.Datum> partners = response.body().getData();
