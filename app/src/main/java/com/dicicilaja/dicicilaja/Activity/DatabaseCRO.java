...
import com.dicicilaja.dicicilaja.API.Interface.InterfaceDatabaseCRO;
import com.dicicilaja.dicicilaja.Adapter.DatabaseCROAdapter;
...
public class DatabaseCRO extends AppCompatActivity implements DatabaseCROAdapter.CROAdapterListener{
    ...
    private List<com.dicicilaja.dicicilaja.API.Item.DatabaseCRO.Datum> dataList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<com.dicicilaja.dicicilaja.API.Item.DatabaseCRO.DatabaseCRO> call = apiService.getDatabaseCRO(apiKey);
        call.enqueue(new Callback<com.dicicilaja.dicicilaja.API.Item.DatabaseCRO.DatabaseCRO>() {
            @Override
            public void onResponse(Call<com.dicicilaja.dicicilaja.API.Item.DatabaseCRO.DatabaseCRO> call, retrofit2.Response<com.dicicilaja.dicicilaja.API.Item.DatabaseCRO.DatabaseCRO> response) {
                List<com.dicicilaja.dicicilaja.API.Item.DatabaseCRO.Datum> items = response.body().getData();
                dataList.clear();
...
//                }));
            ...
            @Override
            public void onFailure(Call<com.dicicilaja.dicicilaja.API.Item.DatabaseCRO.DatabaseCRO> call, Throwable t) {
    ...
    @Override
    public void onDataSelected(com.dicicilaja.dicicilaja.API.Item.DatabaseCRO.Datum datum) {
