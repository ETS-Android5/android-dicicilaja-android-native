...
public class PengajuanMaxiAllAdapter extends RecyclerView.Adapter<PengajuanMaxiAllAdapter.RequestViewHolder>  {
    private List<com.dicicilaja.dicicilaja.API.Item.PengajuanMaxi.Datum> pengajuan;
    ...
    public PengajuanMaxiAllAdapter(List<com.dicicilaja.dicicilaja.API.Item.PengajuanMaxi.Datum> requests, int rowLayout, Context context) {
    ...
    @Override
    public PengajuanMaxiAllAdapter.RequestViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
        return new PengajuanMaxiAllAdapter.RequestViewHolder(view);
    }

    @Override
    public void onBindViewHolder(PengajuanMaxiAllAdapter.RequestViewHolder holder, int position) {
