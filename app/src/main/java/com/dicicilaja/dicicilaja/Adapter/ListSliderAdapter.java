...
public class ListSliderAdapter extends RecyclerView.Adapter<ListSliderAdapter.SingleItemRowHolder> {
    private List<com.dicicilaja.dicicilaja.API.Item.Slider.Datum> sliders;
    private Context mContext;

    public ListSliderAdapter(List<com.dicicilaja.dicicilaja.API.Item.Slider.Datum> sliders, Context mContext) {
    ...
    public void onBindViewHolder(ListSliderAdapter.SingleItemRowHolder holder, final int position) {
        final com.dicicilaja.dicicilaja.API.Item.Slider.Datum itemModel = sliders.get(position);
