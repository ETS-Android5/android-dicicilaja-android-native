...
public class ProgramMaxiAllAdapter extends RecyclerView.Adapter<ProgramMaxiAllAdapter.RequestViewHolder> {
    ...
    public ProgramMaxiAllAdapter(List<Data> program, int rowLayout, Context context) {
    ...
    @Override
    public ProgramMaxiAllAdapter.RequestViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
        return new ProgramMaxiAllAdapter.RequestViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ProgramMaxiAllAdapter.RequestViewHolder holder, int position) {
