...
public class ListProductPartnerAdapter extends RecyclerView.Adapter<ListProductPartnerAdapter.SingleItemRowHolder> {
    private List<Datum> product;
    private Context mContext;
    Integer id;

    public ListProductPartnerAdapter(List<Datum> product, Context mContext) {
    ...
    public void onBindViewHolder(final SingleItemRowHolder holder, final int position) {
        final Datum itemModel = product.get(position);
