package com.dicicilaja.app.Component;
...
public class SwipeRefreshLayoutWithEmpty extends SwipeRefreshLayout {
    ...
    public SwipeRefreshLayoutWithEmpty(@NonNull Context context) {
        super(context);
    }

    public SwipeRefreshLayoutWithEmpty(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
