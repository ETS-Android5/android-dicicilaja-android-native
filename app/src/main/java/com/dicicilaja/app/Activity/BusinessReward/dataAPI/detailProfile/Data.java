package com.dicicilaja.app.Activity.BusinessReward.dataAPI.detailProfile;
...
public class Data {
    ...
    @Expose
    private String incentiveCar;
    @SerializedName("incentive_car_mentor")
    @Expose
    private String incentiveCarMentor;
    @SerializedName("incentive_car_extra_bulanan")
    @Expose
    private String incentiveCarExtraBulanan;
    @SerializedName("incentive_car_group")
    @Expose
    private String incentiveCarGroup;
    @SerializedName("incentive_car_bonus_tahunan")
    @Expose
    private String incentiveCarBonusTahunan;
    @SerializedName("incentive_car_bonus_layout")
    @Expose
    private String incentiveCarBonusLayout;
    @SerializedName("incentive_mcy")
    @Expose
    private String incentiveMcy;
    @SerializedName("incentive_mcy_mentor")
    @Expose
    private String incentiveMcyMentor;
    @SerializedName("incentive_mcy_extra_bulanan")
    @Expose
    private String incentiveMcyExtraBulanan;
    @SerializedName("incentive_mcy_group")
    @Expose
    private String incentiveMcyGroup;
    @SerializedName("incentive_mcy_bonus_tahunan")
    @Expose
    private String incentiveMcyBonusTahunan;
    @SerializedName("incentive_mcy_bonus_layout")
    @Expose
    private String incentiveMcyBonusLayout;
    ...
    public String getIncentiveCar() {
        return incentiveCar;
    }

    public void setIncentiveCar(String incentiveCar) {
        this.incentiveCar = incentiveCar;
    }

    public String getIncentiveCarMentor() {
        return incentiveCarMentor;
    }

    public void setIncentiveCarMentor(String incentiveCarMentor) {
        this.incentiveCarMentor = incentiveCarMentor;
    }

    public String getIncentiveCarExtraBulanan() {
        return incentiveCarExtraBulanan;
    }

    public void setIncentiveCarExtraBulanan(String incentiveCarExtraBulanan) {
        this.incentiveCarExtraBulanan = incentiveCarExtraBulanan;
    }

    public String getIncentiveCarGroup() {
        return incentiveCarGroup;
    }

    public void setIncentiveCarGroup(String incentiveCarGroup) {
        this.incentiveCarGroup = incentiveCarGroup;
    }

    public String getIncentiveCarBonusTahunan() {
        return incentiveCarBonusTahunan;
    }

    public void setIncentiveCarBonusTahunan(String incentiveCarBonusTahunan) {
        this.incentiveCarBonusTahunan = incentiveCarBonusTahunan;
    }

    public String getIncentiveCarBonusLayout() {
        return incentiveCarBonusLayout;
    }

    public void setIncentiveCarBonusLayout(String incentiveCarBonusLayout) {
        this.incentiveCarBonusLayout = incentiveCarBonusLayout;
    }

    public String getIncentiveMcy() {
        return incentiveMcy;
    }

    public void setIncentiveMcy(String incentiveMcy) {
        this.incentiveMcy = incentiveMcy;
    }

    public String getIncentiveMcyMentor() {
        return incentiveMcyMentor;
    }

    public void setIncentiveMcyMentor(String incentiveMcyMentor) {
        this.incentiveMcyMentor = incentiveMcyMentor;
    }

    public String getIncentiveMcyExtraBulanan() {
        return incentiveMcyExtraBulanan;
    }

    public void setIncentiveMcyExtraBulanan(String incentiveMcyExtraBulanan) {
        this.incentiveMcyExtraBulanan = incentiveMcyExtraBulanan;
    }

    public String getIncentiveMcyGroup() {
        return incentiveMcyGroup;
    }

    public void setIncentiveMcyGroup(String incentiveMcyGroup) {
        this.incentiveMcyGroup = incentiveMcyGroup;
    }

    public String getIncentiveMcyBonusTahunan() {
        return incentiveMcyBonusTahunan;
    }

    public void setIncentiveMcyBonusTahunan(String incentiveMcyBonusTahunan) {
        this.incentiveMcyBonusTahunan = incentiveMcyBonusTahunan;
    }

    public String getIncentiveMcyBonusLayout() {
        return incentiveMcyBonusLayout;
    }

    public void setIncentiveMcyBonusLayout(String incentiveMcyBonusLayout) {
