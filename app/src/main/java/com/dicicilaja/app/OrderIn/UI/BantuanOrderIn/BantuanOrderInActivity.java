package com.dicicilaja.app.OrderIn.UI.BantuanOrderIn;
...
public class BantuanOrderInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bantuan_order_in);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.yes:
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(BantuanOrderInActivity.this);
                ...
                break;
            case R.id.no:
                AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(BantuanOrderInActivity.this);
