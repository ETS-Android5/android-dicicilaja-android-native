...
public class LainnyaAdapter extends RecyclerView.Adapter<LainnyaAdapter.RekomendasiViewHolder> {
    ...
    public LainnyaAdapter(List<Datum> dataItems, List<Included> dataIncludeds, Context context) {
    ...
    @NonNull
    @Override
    public LainnyaAdapter.RekomendasiViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_kantor_cabang, parent, false);
        return new LainnyaAdapter.RekomendasiViewHolder(view);
    }
