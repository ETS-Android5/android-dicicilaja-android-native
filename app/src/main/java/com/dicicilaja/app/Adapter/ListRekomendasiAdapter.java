...
public class ListRekomendasiAdapter extends RecyclerView.Adapter<ListRekomendasiAdapter.SingleItemRowHolder> {
    private List<com.dicicilaja.app.Activity.RemoteMarketplace.Item.ItemRecommendation.Datum> recommends;
    private Context mContext;
    Integer id;

    public ListRekomendasiAdapter(List<com.dicicilaja.app.Activity.RemoteMarketplace.Item.ItemRecommendation.Datum> recommends, Context mContext) {
    ...
    public void onBindViewHolder(final SingleItemRowHolder holder, final int position) {
        final com.dicicilaja.app.Activity.RemoteMarketplace.Item.ItemRecommendation.Datum itemModel = recommends.get(position);
