...
public class ListProductCatalog2Adapter extends RecyclerView.Adapter<ListProductCatalog2Adapter.MyViewHolder> {
    ...
    public ListProductCatalog2Adapter(List<ProductCatalog> pcList, Context mContext) {
        this.pcList = pcList;
    ...
    @NonNull
    @Override
    public ListProductCatalog2Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ListProductCatalog2Adapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ListProductCatalog2Adapter.MyViewHolder holder, int position) {
