...
public class AssignSurveyorActivity extends AppCompatActivity {
...
//        webView.getSettings().setDisplayZoomControls(false);
        ...
        webView.setWebChromeClient(new WebChromeClient()
        {
            ...
            public boolean onShowFileChooser(WebView mWebView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams)
            {
                ...
                {
                    uploadMessage = null;
                    Toast.makeText(AssignSurveyorActivity.this, "Cannot Open File Chooser", Toast.LENGTH_LONG).show();
                    return false;
                }
                return true;
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Toast.makeText(AssignSurveyorActivity.this, "Failed to Upload Image", Toast.LENGTH_LONG).show();
    }
