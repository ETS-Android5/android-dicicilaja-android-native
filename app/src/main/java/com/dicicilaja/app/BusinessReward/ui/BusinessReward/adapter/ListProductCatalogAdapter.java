...
import com.dicicilaja.app.BusinessReward.ui.BusinessReward.activity.CatalogResultActivity;
...
public class ListProductCatalogAdapter extends RecyclerView.Adapter<ListProductCatalogAdapter.MyViewHolder> {
    List<com.dicicilaja.app.BusinessReward.dataAPI.kategori.Datum> pcList;
    List<com.dicicilaja.app.BusinessReward.dataAPI.kategori.Included> pcList2;
